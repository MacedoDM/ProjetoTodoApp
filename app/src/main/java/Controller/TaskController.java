...
public class TaskController {
    ...
    public void update(Task task){
        String sql=  "UPDATE tasks SET idProject = ?, name = ?, description = ?"
                + ", note = ?, completed = ?, deadline = ?, createdAt = ?,"
                + "updatedAt = ? WHERE id = ?";
    ...
    public void removeById(int taskId){
        ...
        try{
            ...
            throw new RuntimeException("Erro ao deletar a task", ex);
        } finally{
            ConnectionFactory.closeConnection(connection, statement);
        }
    ...
    public List<Task> getAll(int idProject){
        ...
        try{
            ...
            //Enquanto houverem valores para serem percorridos no meu resultSet
            ...
            throw new RuntimeException("Erro ao inserir a task" , ex);
        }finally{
